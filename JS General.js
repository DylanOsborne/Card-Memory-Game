...
function SetRules() {
    ...
    if(gameMode == "timed") { //if game mode is timed game mode set rules to timed game mode rules
        ...
        list_item_1.innerHTML = "Get as much score as possible before the time runs out";
        list_item_2.innerHTML = "Keep trying to get a higher score";
...
function GenerateBoard() {
    ...
    if(gameMode == "memory") { //if game mode is memory game mode
        ...
        }, 5500); //setting the timeout time to 5.5 seconds
...
function RemoveCards() {
    ...
    if(gameMode == "timed") { //if game mode is timed game mode
        ...
        bottomTabDisplay.innerHTML = cardsLeft; //set bottomTabDisplay to cardsLeft
